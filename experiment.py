...
class Experiment:
    ...
    def random_assign_houses_to_batteries(self):
        # Shuffle the list of houses randomly
        ...
        for house in self.houses:
            ...
            if possible_batteries:
                ...
                # Connect the house to the selected battery
...
print("now the next random algo")
experiment.random_assign_houses_to_batteries()
